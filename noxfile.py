...
_SRC = (
    ...
    "services/ads-sandbox-egress/custody-kernel-smoke.py",
    "services/ads-sandbox-egress/interception-kernel-smoke.py",
    ...
    "services/ads-ptp-tools/ads-ipc-storage",
    "services/ads-ptp-tools/ads-block-release",
    "services/ads-ptp-tools/block-release-kernel-smoke.py",
    ...
    "services/ads-sandbox-ca/src",
    "services/ads-sandbox-ca/tests",
    "noxfile.py",
)
...
def package(session: nox.Session) -> None:
    ...
    session.run("uv", "build", "--package", "ads-sandbox-ca", external=True)
