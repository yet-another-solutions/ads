...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("committed_tombstone_id", sa.Uuid(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("candidate_tombstone_id", sa.Uuid(), nullable=True),
        sa.Column("total_context", sa.Integer(), nullable=True),
        sa.Column("used_context", sa.Integer(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
